...
fn indexed_color(index: u8) -> Rgb {
    const ANSI: [Rgb; 16] = [
        Rgb(30, 34, 42), Rgb(224, 85, 85), Rgb(152, 195, 121), Rgb(229, 192, 123),
        Rgb(97, 175, 239), Rgb(198, 120, 221), Rgb(86, 182, 194), Rgb(215, 218, 224),
        Rgb(92, 99, 112), Rgb(255, 107, 107), Rgb(182, 224, 146), Rgb(255, 215, 142),
        Rgb(119, 190, 255), Rgb(218, 145, 239), Rgb(111, 211, 225), Rgb(255, 255, 255),
    ];
